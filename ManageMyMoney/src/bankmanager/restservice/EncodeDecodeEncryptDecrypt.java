...
public class EncodeDecodeEncryptDecrypt {
    ...
    public static String encryptAndEncodeData(String dataToEncrypt) {
        ...
        try
        {
            ...
            byte[] cryptData = cipher.doFinal(dataToEncrypt.getBytes(StandardCharsets.UTF_8));

            encryptedAndEncodedData = Base64.getUrlEncoder().encodeToString(cryptData);
    ...
    public static String decryptAndDecodeData(String dataToDecrypt) {
        ...
        try
        {
            ...
            byte[] decryptData = cipher.doFinal(decodeDataToByte(dataToDecrypt));
